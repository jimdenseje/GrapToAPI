...
RUN apt-get install -y apache2 php php-curl npm wget unzip nodejs default-jre mariadb-server php-mysqli curl

# install dependecies for google chrome
RUN apt-get install -y fonts-liberation libgbm1
...
# WORKDIR /var/www/html/selenium/
# RUN php run_sides.php
